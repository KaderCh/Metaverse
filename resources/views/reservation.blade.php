...
<body>
    ...
    <div class="datePanel">
        ...
        <span id="nextdate" class="material-symbols-rounded nextdate" onclick="nextDate()" >></span>
                 <div class=" btn-sm-square text-primary  ms-2"x>
                    <a href="#" style="color:#00008B; " onclick="showCalendar()"><i class="fa fa-calendar" aria-hidden="true"></i></a>
    ...
    <div class="container-xxl bg-light my-5 py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px; margin-top:30px;">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
                        ...
                        <div class="horaire">
                        <div class="horaire{{$jeu->id}}">
                                
                        </div>
                        </div>
                        <div  class="text-center p-4 pt-0" style="margin-top:30px; color:blue">
    ...
    <script>
    // function recupD(){
    //     let show = document.getElementById("showdate");
    //     let tab=show.textContent().split(' ').reverse();
    //     if (tab[1]<10) {
    //         // let a = tab[1]+1;
    //         dbDate = tab[0]+'-0';
    //     }else{
        ...
        let request = async() => {
            ...
            .then((response) => {
                if (response.success) {
                    ...
                    for (let i = 0; i < n; i++) {
                        let a=i+1;
                        Place[i]=document.querySelector(".horaire"+a);
                    }
                    for (let j = 0; j < n; j++) {    
